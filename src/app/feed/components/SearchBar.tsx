    ...
    <div ref={searchRef} className="relative w-full max-w-sm">
      <div className="relative">
        ...
        <input
          ...
          onFocus={handleFocus}
          onBlur={handleBlur}
          className="w-full pl-8 pr-4 px-8 py-2 bg-white border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder-gray-500 text-sm"
        />
      </div>
