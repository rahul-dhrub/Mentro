...
interface MediaPreviewModalProps {
  ...
  renderAttachmentIcon: (type: string) => React.JSX.Element;
            ...
            <img
              ...
              onError={(e) => {
                ...
                errorDiv.innerHTML = `
                  ...
                  <a href="${attachment.url}" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-800 underline mt-2 inline-block">Open in New Tab</a>
                `;
        ...
        return (
          <div className="flex items-center justify-center h-full bg-gray-50 rounded-lg">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">{attachment.name}</h3>
